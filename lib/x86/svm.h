...
/*
 * Save area definition for SEV-ES/SNP guest
 * From APM vol2 - Table B4, VMSA layout
 */
struct sev_es_save_area {
	...
	struct vmcb_seg tr;
	u64 vmpl_reserved[4]; // offset 0A0h-0B8h
	u64 ucet;
	u8 reserved_0xc8[2];
	u8 vmpl;
	u8 cpl;
	u8 reserved_0xcc[4];
	u64 efer;
	u8 reserved_0xd8[104]; // offset 0D8h-13Fh
	u64 xss;
	u64 cr4;
	u64 cr3;
	u64 cr0;
	...
	u64 dr2_addr_mask;
	u64 dr3_addr_mask;
	u8 reserved_0x1c0[24]; // offset 1C0h-1D7h
	u64 rsp;
	u64 s_cet;
	u64 ssp;
	u64 isst_addr;
